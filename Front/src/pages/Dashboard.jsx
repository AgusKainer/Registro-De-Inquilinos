...
const Dashboard = () => {
  ...
  return (
    <div className="dashboard">
      ...
      >
        <div>
          ...
          <p style={{ color: "var(--text-secondary)", fontSize: "0.95rem" }}>
            Bienvenido, <b>{user?.nombreEmpresa || user?.username}</b>
          </p>
        </div>
        <button
      ...
      >
        {["inquilinos", "locales", "contratos", "perfil"].map((tab) => (
          <button
            key={tab}
            className="secondary"
            style={{
              ...
              background:
                activeTab === tab ? "var(--accent-gradient)" : "transparent",
